		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column" style="flex-basis: 35%">
				...
				<div class="wp-block-group">
					...
					<!-- wp:site-tagline {"style":{"elements":{"link":{"color":{"text":"var:preset|color|muted-light"}}}},"textColor":"muted-light"} /-->
				</div>
				<!-- /wp:group -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column" style="flex-basis: 40%">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group">
						...
						<!-- wp:navigation {"textColor":"muted-light","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|5"}},"layout":{"type":"flex","orientation":"vertical"},"ariaLabel":"<?php esc_attr_e( 'About', 'sorai' ); ?>"} -->
					...
					<div class="wp-block-group">
						...
						<!-- wp:navigation {"textColor":"muted-light","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|5"}},"layout":{"type":"flex","orientation":"vertical"},"ariaLabel":"<?php esc_attr_e( 'Social', 'sorai' ); ?>"} -->
					...
					<div class="wp-block-group">
						...
						<!-- wp:navigation {"textColor":"muted-light","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|5"}},"layout":{"type":"flex","orientation":"vertical"},"ariaLabel":"<?php esc_attr_e( 'Privacy', 'sorai' ); ?>"} -->
