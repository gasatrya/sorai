...
<!-- wp:group {"style":{"border":{"bottom":{"color":"var:preset|color|border","width":"1px"},"top":[],"right":[],"left":[]}},"layout":{"inherit":"true","type":"constrained"}} -->
<div
...
>
  ...
  >
    ...
    <!-- wp:navigation {"style":{"spacing":{"margin":{"top":"0"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"right","orientation":"horizontal"},"ariaLabel":"<?php esc_attr_e( 'Primary', 'sorai' ); ?>"} -->
