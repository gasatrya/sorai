...
<div class="wp-block-query alignfull">
	...
	<!-- wp:post-featured-image {"isLink":true,"aspectRatio":"16/9","style":{"color":{"duotone":"var:preset|duotone|primary"},"shadow":"var:preset|shadow|md"}} /-->
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-columns alignwide"
			...
			<div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained","justifyContent":"left"}} -->
				<div class="wp-block-group"><!-- wp:post-excerpt {"style":{"typography":{"lineHeight":"1.5"}}} /-->
